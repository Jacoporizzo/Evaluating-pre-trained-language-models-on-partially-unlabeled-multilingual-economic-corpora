...
from utils.translations_copy import Translation
...
trans = Translation()
cosine_scores = trans.cosine_similarity_test(data, goldstandards)
...
cosine_scores.to_pickle('data/cosine_scores_pairs.pkl')
english_labelled.to_pickle('data/english_goldstandards_pairs.pkl')
